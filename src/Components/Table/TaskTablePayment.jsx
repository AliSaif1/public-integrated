...
const TaskTablePayment = ({ DATA, pagination, setPagination, pageCount, totalUsers ,Update ,setUpdate}) => {

  console.log("data is payment")
  console.log(DATA )
  ...
  return (
    <>
      ...
      {selectedRowData && <PaymentModel Update={Update} setUpdate={setUpdate} rowData={selectedRowData} onClose={() => setselectedRowData(null)} />}
...
export default TaskTablePayment;
