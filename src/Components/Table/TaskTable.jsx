...
const TaskTable = ({ DATA, pagination, setPagination, pageCount, totalUsers ,Update ,setUpdate}) => {
  ...
  return (
    <>
      ...
      {selectedRowData && <Modal Update={Update} setUpdate={setUpdate} rowData={selectedRowData} onClose={() => setselectedRowData(null)} />}
